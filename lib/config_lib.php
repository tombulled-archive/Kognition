...
$CFG->local = false; //NOTE: Check me on server push
...
if ($CFG->local)
{
    define('MYSQL_SERVER', 'localhost'); //Assumes running on XAMPP
...
{
    define('MYSQL_SERVER', ''); //Add MySQL Server Details Here
    define('MYSQL_USERNAME', '');
    define('MYSQL_PASSWORD', '');
    define('MYSQL_DB_CORE', '');
}
