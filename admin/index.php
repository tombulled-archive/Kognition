...
<script>
    ...
    {
        var url = "http://kognition.ihostfull.com/admin/delve_class?class_pin=" + class_pin;

        window.top.location.replace(url);
        /*
        var url = "http://kognition.ihostfull.com/api/admin/delve_class?class_pin=" + class_pin;
